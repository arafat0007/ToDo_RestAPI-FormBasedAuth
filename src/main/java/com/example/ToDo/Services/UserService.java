...
public class UserService implements UserDetailsService {
    ...
    public String userRegister(RegistrationRequest request) {
        ...
        emailSenderService.send(request.getEmail(), BuildEmail(request.getFirstName(), TokenConfirmationURL));
    ...
    public String confirmToken(String token) {
        Token confirmToken = tokenService.findByToken(token).orElseThrow(() -> new IllegalStateException("token not found"));
        ...
        tokenService.UpdateToken(confirmToken);
